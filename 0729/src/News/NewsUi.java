...
public class NewsUi extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4188905486169946249L;
		JButton button = null;
		JTable table = null;
	...
	public static void main(String[] args) {
	    ...
	    private void launchUi() {
	        ...
	        // 테이블 구성
	        table = new JTable();
	        String[] header = {"제목", "설명", "발행자", "guid","코멘트", "발행일"};
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                for (News info : list) {
	                    model.addRow(new Object[] {info.getTitle(), info.getDescription(), 
	                    		info.getAuthor(),info.getGuid(),info.getComment(), info.getPubDate()});
	                }
